...
define('SKT_THEME_DOC','https://sktthemesdemo.net/documentation/skt-kraft-doc/');
define('SKT_PRO_THEME_URL','https://www.sktthemes.org/shop/premium-wordpress-theme/');
define('SKT_PRO_FONT_AWESOME_URL','https://fortawesome.github.io/Font-Awesome/icons/');
...
function kraftlite_excerpt_length( $length ) {
        return 20;
    }
    add_filter( 'excerpt_length', 'kraftlite_excerpt_length', 999 );